...
struct Z_Construct_UClass_AStrangeSideEffectsCharacter_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ClearAction_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Input" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Clearing all Side Effects Input Action */" },
#endif
		{ "ModuleRelativePath", "StrangeSideEffectsCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Clearing all Side Effects Input Action" },
#endif
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ClearAction;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AStrangeSideEffectsCharacter_Statics::NewProp_ClearAction = { "ClearAction", nullptr, (EPropertyFlags)0x0040000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrangeSideEffectsCharacter, ClearAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ClearAction_MetaData), NewProp_ClearAction_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AStrangeSideEffectsCharacter_Statics::NewProp_PauseAction = { "PauseAction", nullptr, (EPropertyFlags)0x0040000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrangeSideEffectsCharacter, PauseAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PauseAction_MetaData), NewProp_PauseAction_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AStrangeSideEffectsCharacter_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStrangeSideEffectsCharacter_Statics::NewProp_ClearAction,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStrangeSideEffectsCharacter_Statics::NewProp_PauseAction,
...
struct Z_CompiledInDeferFile_FID_Users_thoma_OneDrive_Bureau_Work_StrangeSideEffect_StrangeSideEffects_Source_StrangeSideEffects_StrangeSideEffectsCharacter_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStrangeSideEffectsCharacter, AStrangeSideEffectsCharacter::StaticClass, TEXT("AStrangeSideEffectsCharacter"), &Z_Registration_Info_UClass_AStrangeSideEffectsCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStrangeSideEffectsCharacter), 4106054272U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_thoma_OneDrive_Bureau_Work_StrangeSideEffect_StrangeSideEffects_Source_StrangeSideEffects_StrangeSideEffectsCharacter_h_3661044555(TEXT("/Script/StrangeSideEffects"),
