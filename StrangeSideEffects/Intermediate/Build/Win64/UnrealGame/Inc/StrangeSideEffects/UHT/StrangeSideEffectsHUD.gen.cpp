...
struct Z_Construct_UClass_AStrangeSideEffectsHUD_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SideEffectsOverlayClass_MetaData[] = {
		{ "Category", "Overlay" },
		{ "ModuleRelativePath", "Public/StrangeSideEffectsHUD.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_EndGameOverlayClass_MetaData[] = {
		{ "Category", "SideEffectsOverlay" },
		{ "ModuleRelativePath", "Public/StrangeSideEffectsHUD.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PauseOverlayClass_MetaData[] = {
		{ "Category", "SideEffectsOverlay" },
		{ "ModuleRelativePath", "Public/StrangeSideEffectsHUD.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FClassPropertyParams NewProp_SideEffectsOverlayClass;
	static const UECodeGen_Private::FClassPropertyParams NewProp_EndGameOverlayClass;
	static const UECodeGen_Private::FClassPropertyParams NewProp_PauseOverlayClass;
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AStrangeSideEffectsHUD_Statics::NewProp_SideEffectsOverlayClass = { "SideEffectsOverlayClass", nullptr, (EPropertyFlags)0x0044000000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrangeSideEffectsHUD, SideEffectsOverlayClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UStrangeSideEffectsOverlay_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SideEffectsOverlayClass_MetaData), NewProp_SideEffectsOverlayClass_MetaData) };
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AStrangeSideEffectsHUD_Statics::NewProp_EndGameOverlayClass = { "EndGameOverlayClass", nullptr, (EPropertyFlags)0x0044000000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrangeSideEffectsHUD, EndGameOverlayClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UEndGameOverlay_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_EndGameOverlayClass_MetaData), NewProp_EndGameOverlayClass_MetaData) };
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_AStrangeSideEffectsHUD_Statics::NewProp_PauseOverlayClass = { "PauseOverlayClass", nullptr, (EPropertyFlags)0x0044000000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AStrangeSideEffectsHUD, PauseOverlayClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PauseOverlayClass_MetaData), NewProp_PauseOverlayClass_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AStrangeSideEffectsHUD_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStrangeSideEffectsHUD_Statics::NewProp_SideEffectsOverlayClass,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStrangeSideEffectsHUD_Statics::NewProp_EndGameOverlayClass,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStrangeSideEffectsHUD_Statics::NewProp_PauseOverlayClass,
};
...
struct Z_CompiledInDeferFile_FID_Users_thoma_OneDrive_Bureau_Work_StrangeSideEffect_StrangeSideEffects_Source_StrangeSideEffects_Public_StrangeSideEffectsHUD_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AStrangeSideEffectsHUD, AStrangeSideEffectsHUD::StaticClass, TEXT("AStrangeSideEffectsHUD"), &Z_Registration_Info_UClass_AStrangeSideEffectsHUD, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AStrangeSideEffectsHUD), 3412635662U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_thoma_OneDrive_Bureau_Work_StrangeSideEffect_StrangeSideEffects_Source_StrangeSideEffects_Public_StrangeSideEffectsHUD_h_3977836257(TEXT("/Script/StrangeSideEffects"),
